...
// looking north 25 degrees up, 90 degree field, 0 stops, camera, stars at 0.4,
...
inline constexpr Preset kPresets[] = {
	...
	{ "Boreal",      { 0, 0.425f, 0.68f, 0.5f, 0.5f, 2, 0.4223f, 0.5624f, 0.4076f, 0.274f, 0.55f, 0.588f, 0.8997f, 0.6f, 0.5886f, 0.35f, 0.4f, 0.6333f, 0.3162f, 0.3333f, 0, 0.5f, 0.35f, 0.5556f, 0.5f, 0.375f, 0, 0.4f, 1, 2 } },
	...
	{ "Rayed Band",  { 0, 0.44f, 0.68f, 0.5f, 0.5f, 1, 0.4223f, 0.48f, 0.75f, 0.22f, 0.55f, 0.65f, 0.92f, 0.5f, 0.3f, 0.92f, 0.4f, 0.6333f, 0.3162f, 0.3333f, 0, 0.5f, 0.35f, 0.5556f, 0.5f, 0.375f, 0, 0.4f, 1, 2 } },
	...
	{ "Australis",   { 1, 0.5f, 0.68f, 0.5f, 0.5f, 2, 0.45f, 0.56f, 0.42f, 0.3f, 0.45f, 0.55f, 0.90f, 0.6f, 0.5f, 0.4f, 0.5f, 0.6333f, 0.3162f, 0.3333f, 0, 0.0f, 0.3f, 0.6f, 0.5f, 0.4f, 0, 0.4f, 1, 2 } },
	//The defaults as the dark-adapted eye sees them: mesopic, grey-green,
	//and the red nearly gone.
	{ "Eye",         { 0, 0.425f, 0.68f, 0.5f, 0.5f, 2, 0.4223f, 0.5624f, 0.4076f, 0.274f, 0.55f, 0.588f, 0.8997f, 0.6f, 0.5886f, 0.35f, 0.4f, 0.6333f, 0.3162f, 0.3333f, 0, 0.5f, 0.35f, 0.5556f, 0.5f, 0.375f, 1, 0.4f, 1, 2 } },
};
