/*
 * Stoatworks Labs - About window data for boreal.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Boreal is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only boreal
 ...
 * five, and Boreal.cpp static_asserts the run so the change cannot land
 * silently.
 */
#pragma once
...
{
    inline constexpr auto name = "boreal";
    inline constexpr auto slug = "boreal";
    inline constexpr auto hook = "The aurora borealis and australis for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/boreal/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/boreal";
